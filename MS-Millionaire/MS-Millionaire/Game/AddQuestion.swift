    ...
    @IBAction func addQuestion(_ sender: Any) {
            ...
            !money.isEmpty
        {
            if moneyTextField.text?.isInt == true {
                ...
                GameResults.shared.userQuestions.append(UserQuestions(questions: [Question(question: "Вопрос от пользователя: " + question, answers: [firstAnswer,secondAnswer,thirdAnswer,fourthAnswer],  correctAnswer: (correctAnswerSegmentedControl.selectedSegmentIndex), money: Int(money) ?? 0)]))
